 ...
 *
 * Created on 18/10/2011, 11:34:42
 */
...
public class DepartamentoView extends JPanel {
    ...
    List<Departamento> listaEditaDepartamento = departamentoDAO.listarTodosDepartamentos();
    int cont = 0;
    static JFrame frame;
    ...
    private void initComponents() {
        ...
        table.setModel(tabelaModel(listaEditaDepartamento));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, table, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), deleteButton, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btCancelar, btInserir, btSalvar, deleteButton});
        ...
        txtNome.setToolTipText("Informe o nome do departamento");

        nomeDepartamentoLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(bordaOk, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BordaErro, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(121, 121, 121))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bordaOk, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == btInserir) {
                DepartamentoView.this.btInserirActionPerformed(evt);
            }
            else if (evt.getSource() == btCancelar) {
                DepartamentoView.this.btCancelarActionPerformed(evt);
            }
            else if (evt.getSource() == btSalvar) {
                DepartamentoView.this.btSalvarActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                DepartamentoView.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == btEditar) {
                DepartamentoView.this.btEditarActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        Departamento excluirDepartamento = listaEditaDepartamento.get(indexExcluir);
        int excluido = departamentoDAO.excluirDepartamento(excluirDepartamento.getCodDepartamento());
        listaEditaDepartamento = departamentoDAO.listarTodosDepartamentos();
        table.setModel(tabelaModel(listaEditaDepartamento));
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        ...
        txtNome.setText("");
        txtNome.setBorder(bordaOk.getBorder());

        txtNome.setEnabled(true);

        txtNome.requestFocus();

        int row = listaEditaDepartamento.size() - 1;
        table.scrollRectToVisible(table.getCellRect(row, 0, true));
    }//GEN-LAST:event_btInserirActionPerformed

    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
       if (txtNome.getText().equals("")){
       JOptionPane.showMessageDialog(null, "O nome do Departamento é de preenchimento obrigatório!");
       txtNome.setBorder(BordaErro.getBorder());
            ...
            int isDepartamento = departamentoDAO.inserirDepartamento(departamento);

            listaEditaDepartamento.add(departamento);
            table.setModel(tabelaModel(listaEditaDepartamento));
            ...
            Departamento departamentoAlterar = listaEditaDepartamento.get(table.getSelectedRow());

            departamentoAlterar.setNome(alterNome);

            departamentoDAO.alteraDepartamento(departamentoAlterar);
...
private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
    ...
    public TableModel tabelaModel(List<Departamento> listaDepartamentos) {
        int n = 0;
        JTable table1;

        listaDepartamentos = departamentoDAO.listarTodosDepartamentos();
        Object[][] data = new Object[listaDepartamentos.size()][2];
        String[] columnNames = {"Cod. Departamento", "Nome"};

        for (Departamento departamentos : listaDepartamentos) {
            data[n][0] = departamentos.getCodDepartamento();
            data[n][1] = departamentos.getNome();

...
public class ComprasView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFornecedor.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        tableProdutos.setFont(new java.awt.Font("Tahoma", 1, 12));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ComprasView.this.setSize(1100,530);
...
//    table.setModel(tabelaModel(ListaEditItensCompras, codCompras));
        ComprasView.this.setSize(700, 530);
